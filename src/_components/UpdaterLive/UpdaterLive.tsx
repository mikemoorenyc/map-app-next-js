...
import { updateMap,getMap } from "@/_actions/maps";
...
import { useLayers, useMapIcon, useMapId, usePageTitle } from "@/_lib/dataHooks";
...
const othersMapped = useOthersMapped(
 ...
 const update =  useMutation(
  ...
  const sendData = async () => {
    ...
    if(!mapId||!layerData||!pageTitle) return ; 

    
    let updated = await updateMap(mapId,pageTitle,layerData,mapIcon||undefined);
    updateMyPresence({
      savePending: false
    })
